...
// Prosta funkcja do hashowania (w produkcji użyj bcrypt)
function hashPassword(password: string): string {
  // Proste hashowanie - w produkcji użyj bcrypt
  return Buffer.from(password + SESSION_SECRET).toString("base64");
}
